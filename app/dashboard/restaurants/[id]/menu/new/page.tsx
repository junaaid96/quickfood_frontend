...
export default function AddMenuItemPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!isAuthenticated || !isRestaurantOwner) {
            setError(
                "You must be logged in as a restaurant owner to add menu items"
            );
            return;
        }
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(
                    errorData.detail || "Failed to create menu item"
                );
            }
            ...
            setError(
                err.message || "Failed to create menu item. Please try again."
            );
        } finally {
            setLoading(false);
        }
